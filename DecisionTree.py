...
class JumpingSmashModel:
    def __init__(self, file_path):
        """
        Initialize the JumpingSmashModel with the path to the data file.
...
if __name__ == "__main__":
    ...
    file_path = 'output_with_phases_all_sheets.xlsx'  # replace with your file path
    jumping_smash_model = JumpingSmashModel(file_path)
